                            ...
                            <div class="card ">
                                <div class="card-content text-center">
                                    ...
                                    <div class="col-12 mt-sm-2 text-start">
                                        <a class="button is-link fw-bold" href="{{ asset('schools/register') }}">School
                                            Registration</a>
                                    ...
                                    <h1 class="title mt-2">SCHOOL LOGIN</h1>
                                    ...
                                    <form class="content col-12  mt-3" action="{{ asset('schools/authenticate') }}"
                                        method="POST">
                                        @csrf
                                        <div class="field">
